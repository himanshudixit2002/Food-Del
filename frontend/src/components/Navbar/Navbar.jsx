...
const Navbar = ({ setShowLogin }) => {
  ...
  return (
    <div className='navbar'>
      ...
      <button className='mobile-menu-toggle' onClick={() => setShowMobileMenu(!showMobileMenu)} aria-label="Toggle Navigation Menu">
      ...
      <div className="navbar-right">
        <img src={assets.search_icon} alt="Search Icon" aria-label="Search" />
        ...
        {!token ? (
          ...
          <div className='navbar-profile'>
            <img src={assets.profile_icon} alt="Profile Icon" aria-label="Profile" />
